...
const { parseJSON, shasum } = require('./util');
...
class AccountMgr {
  ...
  parseRules() {
    ...
    this.entryRules = getStringProperty('entryRules');
  ...
  setEntryRules(str) {
    ...
    storage.setProperty('entryRules', str);
    this.parseRules();
  }
